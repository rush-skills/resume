...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Remote, India}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+91-97171-93630}{{\footnotesize\faPhone*}\hspace*{0.13cm}+91 97171 93630}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Experience}
        ...
        10 months
            ...
            \textbf{Pixotronics}, Software Engineer
            \begin{highlights}
                \item Architected and developed scalable, real-time 3D file processing solutions for the online jewelry business
                \item Created robust, high-performing backend services and DevOps pipelines for iJewel Studio and SquareCubed
        ...
        2 years 5 months
            ...
            \textbf{European Organization for Nuclear Research (CERN)}, Computing Fellow
            \begin{highlights}
                \item Managed core research compute infrastructure, ensuring high availability for a 250k core compute cluster
                \item Designed and implemented fault-tolerant DevOps automation with StackStorm, significantly reducing manual workload
                \item Developed adaptive load shaping solutions for resource-intensive research jobs, addressing critical storage issues
        ...
        1 year 1 month
            ...
            \textbf{Tower Research Capital}, Software Engineer, HPC
            \begin{highlights}
        ...
        11 months
            ...
            \textbf{Myntra}, Software Engineer, BI/Analytics
            \begin{highlights}
                ...
                \item Enhanced Universal Dashboarding Platform (UDP) and Data Democracy Portal (DDP), resulting in improved performance and scalability
                \item Re-architected Personify user segmentation platform, significantly reducing processing time and improving user experience
    ...
    \section{Education}
        ...
        Aug 2013 – July 2017
            ...
            \textbf{IIIT Delhi}, Computer Science and Engineering
            \begin{highlights}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{iJewel Studio (Pixotronics)}
            \begin{highlights}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Solar Savings Calculator (EnergyGrade)}
            \begin{highlights}
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Databases:} PostgreSQL, MongoDB, MySQL, Redshift, MemSQL, SQLite
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{DevOps \& Cloud:} Docker, Kubernetes, AWS, GCP, Terraform, Puppet, StackStorm, HTCondor, Ansible, Slurm, Helm
        \end{onecolentry}
